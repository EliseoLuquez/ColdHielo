...
$cssFeatures = @(
  ...
  @{ Pattern = 'header\s*\{[^}]*min-height\s*:\s*80px'; Label = 'stable mobile header' },
  @{ Pattern = '\.logo-header img\s*\{[^}]*width\s*:\s*152px[^}]*height\s*:\s*auto'; Label = 'increased desktop logo size' },
